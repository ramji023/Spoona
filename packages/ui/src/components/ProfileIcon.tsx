...
export function ProfileCard({ user,onMove }: { user: PopularCreator ,onMove:(path:string)=>void}) {
  return (
    <>
      <div
      onClick={()=>{
      ...
      className="cursor-pointer w-[160px] h-[180px] rounded-2xl group border border-gray-300 hover:border-orange-400 flex flex-col items-center justify-around hover:shadow-xl">
        ...
        <div className="">
          <button className="bg-orange-400 py-1 px-4 text-sm text-white rounded-lg hover:bg-orange-500 cursor-pointer">
            Follow
          </button>
        </div>
      </div>
